...
```
cd existing_repo
git remote add origin https://gitlab.info.iut-tlse3.fr/wwl4521a/project-r2.04-tramegps.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.info.iut-tlse3.fr/wwl4521a/project-r2.04-tramegps/-/settings/integrations)
