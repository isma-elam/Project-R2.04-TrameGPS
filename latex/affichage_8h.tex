...
Ce fichier contient les déclarations des fonctions pour l\textquotesingle{}affichage des données GPS.  
...
Definition at line 56 of file affichage.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{56                            \{}
\DoxyCodeLine{57     \textcolor{keywordtype}{int} choixAffichage=0;}
\DoxyCodeLine{58     printf(\textcolor{stringliteral}{"{}Voulez-\/vouz afficher les données? 1 -\/ oui, 0 -\/ non\(\backslash\)n"{}});}
\DoxyCodeLine{59     scanf(\textcolor{stringliteral}{"{}\%d"{}},\&choixAffichage);}
\DoxyCodeLine{60     \textcolor{keywordflow}{while} (choixAffichage!=1 \&\& choixAffichage!=0)\{}
\DoxyCodeLine{61         printf(\textcolor{stringliteral}{"{}Veillez entrer votre choix.\(\backslash\)n"{}});}
\DoxyCodeLine{62         printf(\textcolor{stringliteral}{"{}Voulez-\/vouz afficher les données? 1 -\/ oui, 0 -\/ non\(\backslash\)n"{}});}
\DoxyCodeLine{63         scanf(\textcolor{stringliteral}{"{}\%d"{}},\&choixAffichage);}
\DoxyCodeLine{64     \}}
\DoxyCodeLine{65     \textcolor{keywordflow}{return} choixAffichage;}
\DoxyCodeLine{66 \}}
...
Definition at line 68 of file affichage.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{68                                            \{}
\DoxyCodeLine{69     printf(\textcolor{stringliteral}{"{}\(\backslash\)nContenu du fichier \(\backslash\)"{}\%s\(\backslash\)"{} : \(\backslash\)n"{}},nomFic);}
\DoxyCodeLine{70     FILE* file;}
\DoxyCodeLine{71     file = fopen(nomFic,\textcolor{stringliteral}{"{}r"{}});}
\DoxyCodeLine{72     \textcolor{keywordflow}{if} (file==NULL)\{}
\DoxyCodeLine{73         printf(\textcolor{stringliteral}{"{}Impossible d'ouvrir en lecture le fichier \%s\(\backslash\)n"{}},nomFic);}
\DoxyCodeLine{74     \}}
\DoxyCodeLine{75     \textcolor{keywordtype}{char} c;}
\DoxyCodeLine{76     \textcolor{keywordflow}{if} (c == EOF) \{}
\DoxyCodeLine{77         printf(\textcolor{stringliteral}{"{}File is empty or couldn't be read.\(\backslash\)n"{}});}
\DoxyCodeLine{78         fclose(file);}
\DoxyCodeLine{79     \}}
\DoxyCodeLine{80     printf(\textcolor{stringliteral}{"{}\%c"{}},c);}
\DoxyCodeLine{81     \textcolor{keywordflow}{while} (c != EOF)\{}
\DoxyCodeLine{82         printf(\textcolor{stringliteral}{"{}\%c"{}},c);}
\DoxyCodeLine{83         c=fgetc(file);}
\DoxyCodeLine{84     \}}
\DoxyCodeLine{85     fclose(file);}
\DoxyCodeLine{86     }
\DoxyCodeLine{87 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{41                    \{}
\DoxyCodeLine{42     \textcolor{keywordtype}{int} choix = -\/1;}
...
\DoxyCodeLine{47     scanf(\textcolor{stringliteral}{"{}\%d"{}},\&choix);}
\DoxyCodeLine{48     \textcolor{keywordflow}{while}(choix<0||choix>2)\{}
\DoxyCodeLine{49         printf(\textcolor{stringliteral}{"{}\(\backslash\)nErreur de saisie, veuillez réessayer.\(\backslash\)n\(\backslash\)n"{}});}
\DoxyCodeLine{50         \mbox{\hyperlink{affichage_8c_a7c190fbca47364a8ddc6c5a2c50c308e}{affichageMenu}}(\&choix);}
\DoxyCodeLine{51         scanf(\textcolor{stringliteral}{"{}\%d"{}},\&choix);}
\DoxyCodeLine{52     \} }
\DoxyCodeLine{53     \textcolor{keywordflow}{return} choix;}
\DoxyCodeLine{54 \}}
