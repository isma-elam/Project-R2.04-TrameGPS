...
Ce fichier contient les déclarations des fonctions pour charger les données GPS.  
...
\begin{DoxyCompactList}\small\item\em Structure contenant un tableau de trames et le nombre de trames. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\#define {\bfseries LONGUEUR\+\_\+\+TRAME}~200
\item 
...
\DoxyCodeLine{58             \mbox{\hyperlink{verificationFormat_8c_acf17eff23be33d9dda8876705952027a}{verifier\_latitude}}(tInfo.latitude.degre,tInfo.latitude.minute,tInfo.latitude.second,ptRep);}
\DoxyCodeLine{59             \mbox{\hyperlink{verificationFormat_8c_a6e6448a215b6acf053b0dba7d8be47be}{verifier\_longitude}}(tInfo.longitude.degre,tInfo.longitude.minute,tInfo.longitude.second,ptRep);}
...
\DoxyCodeLine{81         \mbox{\hyperlink{verificationFormat_8c_acf17eff23be33d9dda8876705952027a}{verifier\_latitude}}(tInfo.latitude.degre,tInfo.latitude.minute,tInfo.latitude.second,ptRep);}
\DoxyCodeLine{82         \mbox{\hyperlink{verificationFormat_8c_a6e6448a215b6acf053b0dba7d8be47be}{verifier\_longitude}}(tInfo.longitude.degre,tInfo.longitude.minute,tInfo.longitude.second,ptRep);}
...
\DoxyCodeLine{100             fprintf(file,\textcolor{stringliteral}{"{}Heure : \%dh\%dm\%ds ; Latitude : \%d°\%d\(\backslash\)'\%.2f\(\backslash\)"{} ; Longitude : \%d°\%d\(\backslash\)'\%.2f\(\backslash\)"{}\(\backslash\)n"{}},}
